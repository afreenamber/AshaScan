...
class User(Base):
    ...
    role = Column(String(20), nullable=False, default="ASHA")
...
class Patient(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    offline_id = Column(String(64), unique=True, nullable=True, index=True)
...
class Screening(Base):
    ...
    image_quality = Column(String(30), nullable=False)
...
class Referral(Base):
    ...
    # PENDING -> REFERRED -> OVERDUE -> RESOLVED
